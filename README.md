...
- All your project code into a single main package (`aequitas-flow/`)
...
1. Use this template to create a new GitHub repository, say `aequitas-flow`
...
2. Clone the `aequitas-flow` repository
...
13. Put your main (resp. test) code in `aequitas-flow/` (resp. `test/`)
